table 50101 "CSD Customer Subscription"
{
    ...
    fields
    {
        field(1; "Customer No"; Code[20]) { Caption = 'Customer No'; TableRelation = Customer; }
        field(2; "Subscription Code"; Code[10])
        {
            ...
            var
                ...
                Item: Record Item;
            begin
                IF "Subscription Code" <> xRec."Subscription Code" THEN xRec.TESTFIELD("Last Invoice Date", 0D);
                ...
                IF Subscription."Invoicing Price" <> 0 THEN "Invoicing Price" := Subscription."Invoicing Price";
    ...
    keys
    {
        key(PK; "Customer No", "Subscription Code") { Clustered = true; }
    }
